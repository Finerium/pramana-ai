  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {MEMBER_COPY["suara.judul"]}
        </h1>
        <p style={{ margin: 0, fontSize: 13, color: "var(--muted)" }}>
          {MEMBER_COPY["suara.sub"]}
        </p>
      </header>
        ...
        {qs.length > 0 ? (
          qs.map((q, i) => (
            ...
            >
              <span
                className="tnum"
                style={{ fontSize: 15.5, fontWeight: 650, lineHeight: 1.4 }}
              >
                {isi(MEMBER_COPY["suara.pertanyaan.hitung"], {
                  n: q.jumlahAnggota,
                })}
              </span>
              <span
              ...
              {q.milikAnda ? (
                ...
                >
                  ...
                  <span style={{ fontSize: 11.5, fontWeight: 700 }}>
                    {MEMBER_COPY["suara.pertanyaan.milikAnda"]}
                  </span>
                </span>
              ) : null}
              <button
          ...
          >
            ...
            >
              {MEMBER_COPY["suara.pertanyaan.kosong"]}
            </span>
          </div>
        )}
      </section>
...
function KeputusanCard({
  ...
  const lock = chosen
    ...
    : isi(MEMBER_COPY["suara.vote.lockTersimpan"], {
        lanjut: MEMBER_COPY["suara.vote.terkunci"],
      });
      ...
      >
        ...
        >
          <span
            style={{
              ...
              borderRadius: "50%",
              background:
                k.status === "terbuka" ? "var(--hijau)" : "var(--muted)",
              flex: "none",
            }}
          />
          <span
          ...
          >
            {k.status === "terbuka"
              ? MEMBER_COPY["suara.keputusan.terbuka"]
              : MEMBER_COPY["suara.keputusan.ditutup"]}
          </span>
        </span>
        <div style={{ display: "flex", flexDirection: "column", gap: 4 }}>
          ...
          {k.nominal != null ? (
            <span
              className="tnum"
              style={{ fontSize: 23, fontWeight: 700, letterSpacing: -0.4 }}
            >
              {fmtRp(k.nominal)}
            </span>
          ) : null}
        ...
        {!sudahVote ? (
          <>
            ...
            <span style={{ fontSize: 12.5, color: "var(--muted)" }}>
              {MEMBER_COPY["suara.vote.sebelum"]}
            </span>
          </>
        ) : (
          <div
          ...
          >
            <span className="tnum" style={{ fontSize: 15, fontWeight: 650 }}>
              {isi(MEMBER_COPY["suara.hasil.hitung"], {
                tot,
                total: TOTAL_ANGGOTA,
              })}
            </span>
            <div
              role="img"
              aria-label={isi(MEMBER_COPY["suara.hasil.aria"], {
                s: sCount,
                t: tCount,
                b: belum,
              })}
                    ...
                    background:
                      d === "setuju"
                        ...
                        : d === "tidak"
                          ...
                          : "transparent",
                    border:
                      d === "belum" ? "1.5px solid var(--border)" : "none",
                    boxSizing: "border-box",
                  }}
                />
              ))}
            ...
            >
              <Legend
                color="var(--accent)"
                label={isi(MEMBER_COPY["suara.legend.setuju"], { n: sCount })}
              />
              <Legend
                color="var(--muted)"
                label={isi(MEMBER_COPY["suara.legend.tidak"], { n: tCount })}
              />
              <Legend
                border
                label={isi(MEMBER_COPY["suara.legend.belum"], { n: belum })}
              />
            </div>
            <div
              style={{
            ...
            >
              <IkonGembok
                size={15}
                style={{ stroke: "var(--muted)", marginTop: 1 }}
                strokeWidth={1.9}
              />
              <span
