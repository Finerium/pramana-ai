...
export function Arus() {
  ...
  const { muat } = useResource<FlowResp>(
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {MEMBER_COPY["arus.judul"]}
        </h1>
        <p style={{ margin: 0, fontSize: 13, color: "var(--muted)" }}>
          {MEMBER_COPY["arus.sub"]}
        </p>
      </header>
  ...
  return (
    <>
      ...
      >
        ...
        >
          <div style={{ display: "flex", flexDirection: "column", gap: 2 }}>
            <span style={{ fontSize: 15, fontWeight: 650 }}>
              {MEMBER_COPY["arus.kas.judul"]}
            </span>
            <span style={{ fontSize: 12.5, color: "var(--muted)" }}>
              {MEMBER_COPY["arus.kas.sub"]}
            </span>
          </div>
          <button
            type="button"
          ...
          >
            ...
            {isi(MEMBER_COPY["arus.kas.turunChip"], {
              persen: kasTurunPersen(),
            })}
          </button>
        </div>
        <div
            ...
            >
              <span
                ...
                style={{
                  ...
                  fontWeight: 650,
                  textAlign: "center",
                  color: k.isLast ? "var(--ink)" : "var(--muted)",
                }}
              >
                {k.val}
              </span>
        ...
        >
          {isi(MEMBER_COPY["arus.kas.turunTeks"], {
            rp: fmtRp(kasTurunRupiah()),
          })}
        </p>
      </section>
      ...
      >
        ...
        >
          ...
          <CountUp
            ...
            value={f.totalMasuk}
            format={fmtRp}
            style={{ fontSize: 19, fontWeight: 650, letterSpacing: -0.4 }}
          />
        </div>
        <div
          style={cardStyle({
      ...
      <BarSection
        label={MEMBER_COPY["arus.masuk.label"]}
        bars={masuk}
        color="var(--accent)"
        delay={0.15}
        d0={0.2}
      />
      <BarSection
        label={MEMBER_COPY["arus.keluar.label"]}
        bars={keluar}
        color="var(--muted)"
        delay={0.2}
        d0={0.25}
      ...
      {bars.map((b, i) => (
        ...
        >
          ...
          >
            ...
            <span className="tnum" style={{ fontSize: 13.5, fontWeight: 650 }}>
              {b.amt}
            </span>
          </div>
          <div
