...
export function Temuan() {
  ...
  return (
    ...
    >
      ...
      >
        <BackLink
          label={MEMBER_COPY["temuan.kembali"]}
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {AGENT_LABELS.anggota[f.agent]}
        </span>
      </div>

      <h3
        style={{ margin: 0, fontSize: 16.5, fontWeight: 650, lineHeight: 1.35 }}
      >
        {f.judul}
      </h3>
      ...
      >
        ...
        {f.bukti.map((b, j) => (
          ...
          >
            <IkonDokumen
              size={13}
              style={{ stroke: "var(--muted)", marginTop: 2.5 }}
              strokeWidth={1.9}
            />
            <span
              className="tnum"
      ...
      >
        ...
        >
          {MEMBER_COPY["temuan.pertanyaan"]}
        </span>
        <span style={{ fontSize: 14.5, fontWeight: 600, lineHeight: 1.5 }}>
          {f.pertanyaan_rat}
        </span>
      </div>
      ...
      {!added ? (
        ...
        >
          ...
          />
          <span style={{ fontSize: 13.5, lineHeight: 1.5, fontWeight: 600 }}>
            {COPY["temuan.tambah.ok"]}
          </span>
        </div>
      )}
