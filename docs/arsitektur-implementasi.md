...
| c. auth + API routes                     | lib/auth.ts, lib/api.ts, lib/env.ts, lib/logger.ts, lib/rateLimit.ts, lib/audit/buildSnapshot.ts + persist.ts (file BARU), app/api/**                         | 2    | adversarial   | ~120k  |
...
| e. UI pemerintah (port)                  | app/(gov)/**, components/gov/** (termasuk login-variant F-09), styles/tokens/dashboard.css                                                                    | 2    | single + spot | ~100k  |
| h. UI konsol subjek (port)               | app/(subjek)/**, components/subjek/** (termasuk login-variant F-09), styles/tokens/subjek.css                                                                 | 2    | single + spot | ~80k   |
